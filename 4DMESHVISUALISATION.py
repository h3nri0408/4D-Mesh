##4D MESH VISUALISATION USING 3D LAYER METHOD
...
##UNIQUE VISUALISATION IN ONW WINDOW
def visualise_4d_mesh(nodes_list, simplices, disconnected_nodes, chosen_node=470):
#     unique_4th_coords = sorted(set(node[4] for node in nodes_list))
...
##FOR UNIQUE WINDOWS
#visualise_4d_mesh(nodes_list, simplices, disconnected_nodes, chosen_node=470)
##FOR SEPARATED WINDOWS
visualise_4d_mesh_separate_windows(nodes_list, simplices, disconnected_nodes, chosen_node=325)
##CHANGE chosen_node to see different nodes visualisations
